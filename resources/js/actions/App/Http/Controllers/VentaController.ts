 ...
 * @see app/Http/Controllers/VentaController.php:2071
 ...
 * @see app/Http/Controllers/VentaController.php:2173
 ...
 * @see app/Http/Controllers/VentaController.php:2476
 ...
 * @see app/Http/Controllers/VentaController.php:2862
...
/**
* @see \App\Http\Controllers\VentaController::searchWithPrestables
 * @see app/Http/Controllers/VentaController.php:109
 ...
 * @see app/Http/Controllers/VentaController.php:877
 ...
 * @see app/Http/Controllers/VentaController.php:1941
 ...
 * @see app/Http/Controllers/VentaController.php:1870
 ...
 * @see app/Http/Controllers/VentaController.php:1903
 ...
 * @see app/Http/Controllers/VentaController.php:1332
 ...
 * @see app/Http/Controllers/VentaController.php:2629
 ...
 * @see app/Http/Controllers/VentaController.php:2737
 ...
 * @see app/Http/Controllers/VentaController.php:1273
 * @route '/api/ventas/{venta}'
 */
 ...
 * @see app/Http/Controllers/VentaController.php:1306
 * @route '/api/ventas/{venta}'
 */
 ...
 * @see app/Http/Controllers/VentaController.php:3174
 ...
 * @see app/Http/Controllers/VentaController.php:3294
 ...
 * @see app/Http/Controllers/VentaController.php:3245
...
export const getClienteById = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getClienteById.url(args, options),
    method: 'get',
})

getClienteById.definition = {
    methods: ["get","head"],
...
getClienteById.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return getClienteById.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 */
    const getClienteByIdForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: getClienteById.url(args, options),
        method: 'get',
    })
 ...
 */
        getClienteByIdForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: getClienteById.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
 ...
 * @see app/Http/Controllers/VentaController.php:3360
...
export const getUsuarioById = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getUsuarioById.url(args, options),
    method: 'get',
})

getUsuarioById.definition = {
    methods: ["get","head"],
    url: '/api/ventas/usuarios/{id}',
} satisfies RouteDefinition<["get","head"]>
...
getUsuarioById.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return getUsuarioById.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 */
    const getUsuarioByIdForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: getUsuarioById.url(args, options),
        method: 'get',
    })
 ...
 */
        getUsuarioByIdForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: getUsuarioById.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    getUsuarioById.form = getUsuarioByIdForm
/**
* @see \App\Http\Controllers\VentaController::checkCajaAbierta
 * @see app/Http/Controllers/VentaController.php:604
 ...
 * @see app/Http/Controllers/VentaController.php:532
 * @route '/ventas/create'
 */
 ...
 * @see app/Http/Controllers/VentaController.php:2254
 ...
 * @see app/Http/Controllers/VentaController.php:1790
 ...
 * @see app/Http/Controllers/VentaController.php:1817
 ...
 * @see app/Http/Controllers/VentaController.php:2278
 ...
 * @see app/Http/Controllers/VentaController.php:2314
 ...
 * @see app/Http/Controllers/VentaController.php:3142
 ...
 * @see app/Http/Controllers/VentaController.php:2900
...
export const storeConfirmacion = (args: { venta: string | number } | [venta: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeConfirmacion.url(args, options),
    method: 'post',
})

storeConfirmacion.definition = {
    methods: ["post"],
...
storeConfirmacion.url = (args: { venta: string | number } | [venta: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return storeConfirmacion.definition.url
            .replace('{venta}', parsedArgs.venta.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 */
    const storeConfirmacionForm = (args: { venta: string | number } | [venta: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: storeConfirmacion.url(args, options),
        method: 'post',
    })
 ...
 * @see app/Http/Controllers/VentaController.php:3056
...
export const destroyConfirmacion = (args: { venta: string | number, confirmacion: string | number } | [venta: string | number, confirmacion: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroyConfirmacion.url(args, options),
    method: 'delete',
})

destroyConfirmacion.definition = {
    methods: ["delete"],
...
destroyConfirmacion.url = (args: { venta: string | number, confirmacion: string | number } | [venta: string | number, confirmacion: string | number ], options?: RouteQueryOptions) => {
    ...
    return destroyConfirmacion.definition.url
            .replace('{venta}', parsedArgs.venta.toString())
 ...
 */
    const destroyConfirmacionForm = (args: { venta: string | number, confirmacion: string | number } | [venta: string | number, confirmacion: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: destroyConfirmacion.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'DELETE',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
