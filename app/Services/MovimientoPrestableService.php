    ...
    public function registrarMovimiento(array $data): MovimientoPrestable
    {
        try {
            $movimiento = MovimientoPrestable::create([
                ...
                'prestamo_evento_anterior' => $data['prestamo_evento_anterior'] ?? 0,
                'prestamo_proveedor_anterior' => $data['prestamo_proveedor_anterior'] ?? 0,
                'compra_anterior' => $data['compra_anterior'] ?? 0,
                ...
                'prestamo_evento_posterior' => $data['prestamo_evento_posterior'] ?? 0,
                'prestamo_proveedor_posterior' => $data['prestamo_proveedor_posterior'] ?? 0,
                'compra_posterior' => $data['compra_posterior'] ?? 0,
                'vendida_posterior' => $data['vendida_posterior'] ?? 0,
                'cantidad_cliente_dañada_anterior' => $data['cantidad_cliente_dañada_anterior'] ?? 0,
                'cantidad_cliente_dañada_posterior' => $data['cantidad_cliente_dañada_posterior'] ?? 0,
                ...
                'cantidad_proveedor_dañada_anterior' => $data['cantidad_proveedor_dañada_anterior'] ?? 0,
                'cantidad_proveedor_dañada_posterior' => $data['cantidad_proveedor_dañada_posterior'] ?? 0,
