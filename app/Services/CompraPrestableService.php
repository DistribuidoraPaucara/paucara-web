...
class CompraPrestableService
{
    ...
    private function procesarDetalleCompra(CompraPrestable $compra, CompraPrestableDetalle $detalle): void
    {
        ...
        $this->movimientoService->registrarMovimiento([
            ...
            'prestamo_cliente_anterior' => $stockAntes['cantidad_cliente_deudor'],
            'prestamo_proveedor_anterior' => $stockAntes['cantidad_proveedor_acreedor'],
            'vendida_anterior' => 0,
            'disponible_posterior' => $stockDespues['cantidad_disponible'],
            'prestamo_cliente_posterior' => $stockDespues['cantidad_cliente_deudor'],
            'prestamo_proveedor_posterior' => $stockDespues['cantidad_proveedor_acreedor'],
            'vendida_posterior' => 0,
    ...
    private function snapshotStock(PrestableStock $stock): array
    {
        return [
            ...
            'cantidad_cliente_deudor' => (int) ($stock->cantidad_cliente_deudor ?? 0),
            'cantidad_cliente_devuelto' => (int) ($stock->cantidad_cliente_devuelto ?? 0),
            'cantidad_evento_deudor' => (int) ($stock->cantidad_evento_deudor ?? 0),
            'cantidad_evento_devuelto' => (int) ($stock->cantidad_evento_devuelto ?? 0),
            'cantidad_proveedor_acreedor' => (int) ($stock->cantidad_proveedor_acreedor ?? 0),
            'cantidad_proveedor_devuelto' => (int) ($stock->cantidad_proveedor_devuelto ?? 0),
