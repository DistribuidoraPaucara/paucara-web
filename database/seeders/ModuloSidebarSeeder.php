        ...
        return [
            ...
            'prestamos'       => [
                ...
                'submenu' => [
                    ...
                    ['titulo' => 'Stock Eventos', 'ruta' => '/prestamos/stock/eventos', 'icono' => 'Truck', 'orden' => 3, 'permisos' => ['prestamos.index']],
                    ['titulo' => 'Stock Proveedores', 'ruta' => '/prestamos/stock/proveedores', 'icono' => 'Truck', 'orden' => 4, 'permisos' => ['prestamos.index']],
                    // reportes
                    ['titulo' => 'Reportes de Préstamos', 'ruta' => '/prestamos/reportes', 'icono' => 'BarChart4', 'orden' => 5, 'permisos' => ['prestamos.reportes.index']],
                    ['titulo' => 'Prestamos Eventos', 'ruta' => '/prestamos/eventos', 'icono' => 'Calendar', 'orden' => 6, 'permisos' => ['prestamos.index']],
